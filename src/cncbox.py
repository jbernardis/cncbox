...
class MainFrame(wx.Frame):
	def __init__(self):
		...
		staticboxsizer.AddSpacer((300, 10))
		...
		self.rbRlfNone = wx.RadioButton(self, wx.ID_ANY, " None ", style = wx.RB_GROUP, size=(100, -1) )
		self.rbRlfHeight = wx.RadioButton(self, wx.ID_ANY, " Tab/Slot Height ", size=(100, -1) )
		self.rbRlfWidth = wx.RadioButton(self, wx.ID_ANY, " Tab/Slot Width ", size=(100, -1) )
		...
		staticboxsizer.AddSpacer((260, 10))
